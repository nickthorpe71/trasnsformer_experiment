...
class Head(nn.Module):
    ...
    def __init__(self, num_embedding_dimensions: int, head_size: int, block_size: int):
        super().__init__()
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads: int, num_embedding_dimensions: int, head_size: int, block_size: int):
        super().__init__()
